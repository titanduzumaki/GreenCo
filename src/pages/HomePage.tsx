  ...
  const services = [
    {
      ...
      description: "Modern electrical grid solutions for sustainable energy distribution",
      icon: "⚡"
    },
    {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
              GreenCo is your trusted electricity infrastructure partner, delivering innovative solutions 
              that power communities and drive sustainable growth.
            </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/70 max-w-2xl mx-auto">
              Experience excellence with our proven expertise and commitment to quality
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {Array.from({ length: 4 }).map((_, index) => (
              <div key={index} className="aspect-square overflow-hidden rounded-lg">
                <ImageWithFallback
                  src={`https://images.unsplash.com/photo-${1580000000000 + index * 100000}?w=300&h=300&fit=crop&auto=format`}
                  alt={`Project ${index + 1}`}
