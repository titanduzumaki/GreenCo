...
export function GalleryPage() {
  ...
  const categories = ['All', 'Power Grids', 'Smart Cities', 'Renewable Energy', 'Maintenance'];
  ...
  const galleryImages = [
    {
      ...
      description: 'State-of-the-art electrical grid infrastructure in downtown metropolitan area.'
    },
    {
      id: 2,
      ...
      description: 'Intelligent LED street lighting with IoT sensors and remote monitoring capabilities.'
    },
    {
      id: 3,
      ...
      description: 'Large-scale solar installation connected to the regional power grid.'
    },
    {
      id: 4,
      ...
      description: 'Routine maintenance and inspection of critical electrical infrastructure.'
    },
    {
      id: 5,
      ...
      category: 'Renewable Energy',
      description: 'Wind turbine farm connected to the main electrical distribution network.'
    },
    {
      id: 6,
      ...
      category: 'Power Grids',
      description: 'Upgrading legacy electrical systems with modern smart grid technology.'
    },
    {
      id: 7,
      ...
      category: 'Smart Cities',
      description: 'Intelligent traffic management system with integrated power distribution.'
    },
    {
      id: 8,
      ...
      category: 'Maintenance',
      description: '24/7 emergency response team restoring power after severe weather.'
    },
    {
      id: 9,
      ...
      category: 'Renewable Energy',
      description: 'Grid-scale battery storage system for renewable energy integration.'
    }
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl lg:text-5xl font-bold text-white mb-6">
            Project <span className="bg-gradient-to-r from-green-400 to-blue-500 bg-clip-text text-transparent">Gallery</span>
          </h1>
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            Explore our portfolio of successful electrical infrastructure projects. 
            From power grid modernization to renewable energy integration, 
