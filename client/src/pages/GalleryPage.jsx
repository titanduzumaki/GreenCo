...
//     id: img.id || `masonry-${i}`,
//     img: img.src,
//     url: "#", // you can link project URLs here if needed
//     height: 400 + Math.floor(Math.random() * 250), // Randomized heights for better layout
//     index: i,
//   }));
        ...
        {loading ? (
          ...
          <div className="flex justify-center mt-1">
            {isMobile ? (
              ...
              <div className="w-full relative overflow-visible block pb-40 min-h-[80vh]">
                <Masonry
                  items={masonryItems}
                  ease="power3.out"
                  duration={0.6}
